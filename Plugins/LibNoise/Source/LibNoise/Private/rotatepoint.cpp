  ...
  double zAngle)
{
  ...
  xCos = cos (xAngle * 0.01745329251);
  yCos = cos (yAngle * 0.01745329251);
  zCos = cos (zAngle * 0.01745329251);
  xSin = sin (xAngle * 0.01745329251);
  ySin = sin (yAngle * 0.01745329251);
  zSin = sin (zAngle * 0.01745329251);
